...
{
    public class CompleteServiceOrderCommand : IRequest<Result>
    {
        public int Id { get; set; }

        internal class CompleteServiceOrderCommandHandler : IRequestHandler<CompleteServiceOrderCommand, Result>
        {
